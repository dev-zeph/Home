...
const Ibadan = () => {
  ...
  const ibadanAreas = [
    'Bodija', 'Jericho', 'Ring Road', 'Dugbe', 'UI', 'Bashorun',
    'Mokola', 'Agodi', 'Challenge', 'Ologuneru', 'Sango', 'Ojoo'
  ];
    ...
    <div className="city-page">
      <Grid fullWidth>
        ...
        <Column lg={16} md={8} sm={4} className="city-hero" style={{
          backgroundImage: `linear-gradient(135deg, rgba(15, 98, 254, 0.3) 0%, rgba(0, 45, 156, 0.3) 100%), url(${IbadanImage})`,
          ...
          <div className="city-hero-content">
            <Breadcrumb>
              ...
              <BreadcrumbItem isCurrentPage>Ibadan</BreadcrumbItem>
            </Breadcrumb>
          ...
          <Grid className="search-content" fullWidth>
            ...
            <Column lg={4} md={8} sm={4} className="filters-column">
              <div className="filters-panel">
                <h3>Search Ibadan Properties</h3>
            ...
            <Column lg={12} md={8} sm={4}>
              <div className="listings-results">
                ...
                {loading ? (
                  <Loading description="Loading Ibadan properties..." />
                ) : (
                  <>
                    <p>{properties.length} properties found in Ibadan</p>
                    ...
                    <div className="listings-grid">
                      ...
                      {properties.length === 0 && !loading && (
                        <div className="no-results">
                          <p>No properties found in Ibadan. Try adjusting your search criteria.</p>
                        </div>
                      )}
                    </div>
                  </>
