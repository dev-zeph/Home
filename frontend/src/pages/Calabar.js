...
const Calabar = () => {
  ...
  const calabarAreas = [
    'Calabar Municipal', 'Odukpani', 'Akpabuyo', 'Bakassi', 'Biase',
    'Boki', 'Etung', 'Ikom', 'Obanliku', 'Obubra', 'Obudu', 'Ogoja'
  ];
    ...
    <div className="city-page">
      <Grid fullWidth>
        ...
        <Column lg={16} md={8} sm={4} className="city-hero" style={{
          backgroundImage: `linear-gradient(135deg, rgba(15, 98, 254, 0.3) 0%, rgba(0, 45, 156, 0.3) 100%), url(${CalabarImage})`,
          ...
          <div className="city-hero-content">
            <Breadcrumb>
              ...
              <BreadcrumbItem isCurrentPage>Calabar</BreadcrumbItem>
            </Breadcrumb>
          ...
          <Grid className="search-content" fullWidth>
            ...
            <Column lg={4} md={8} sm={4} className="filters-column">
              <div className="filters-panel">
                <h3>Search Calabar Properties</h3>
            ...
            <Column lg={12} md={8} sm={4}>
              <div className="listings-results">
                ...
                {loading ? (
                  <Loading description="Loading Calabar properties..." />
                ) : (
                  <>
                    <p>{properties.length} properties found in Calabar</p>
                    ...
                    <div className="listings-grid">
                      ...
                      {properties.length === 0 && !loading && (
                        <div className="no-results">
                          <p>No properties found in Calabar. Try adjusting your search criteria.</p>
                        </div>
                      )}
                    </div>
                  </>
