...
const PortHarcourt = () => {
  ...
  const portHarcourtAreas = [
    'GRA Phase 1', 'GRA Phase 2', 'Old GRA', 'D-Line', 'Woji', 'Ada George',
    'Trans Amadi', 'Mile 3', 'Mile 4', 'Rumuola', 'Rumuokwurushi', 'Elelenwo'
  ];
    ...
    <div className="city-page">
      <Grid fullWidth>
        ...
        <Column lg={16} md={8} sm={4} className="city-hero" style={{
          backgroundImage: `linear-gradient(135deg, rgba(15, 98, 254, 0.3) 0%, rgba(0, 45, 156, 0.3) 100%), url(${PortHarcourtImage})`,
          ...
          <div className="city-hero-content">
            <Breadcrumb>
              ...
              <BreadcrumbItem isCurrentPage>Port Harcourt</BreadcrumbItem>
            </Breadcrumb>
          ...
          <Grid className="search-content" fullWidth>
            ...
            <Column lg={4} md={8} sm={4} className="filters-column">
              <div className="filters-panel">
                <h3>Search Port Harcourt Properties</h3>
            ...
            <Column lg={12} md={8} sm={4}>
              <div className="listings-results">
                ...
                {loading ? (
                  <Loading description="Loading Port Harcourt properties..." />
                ) : (
                  <>
                    <p>{properties.length} properties found in Port Harcourt</p>
                    ...
                    <div className="listings-grid">
                      ...
                      {properties.length === 0 && !loading && (
                        <div className="no-results">
                          <p>No properties found in Port Harcourt. Try adjusting your search criteria.</p>
                        </div>
                      )}
                    </div>
                  </>
