...
const Kano = () => {
  ...
  const kanoAreas = [
    'Nassarawa GRA', 'Bompai', 'Fagge', 'Dala', 'Gwale', 'Kano Municipal',
    'Tarauni', 'Ungogo', 'Kumbotso', 'Warawa', 'Rijiyar Lemo', 'Zoo Road'
  ];
    ...
    <div className="city-page">
      <Grid fullWidth>
        ...
        <Column lg={16} md={8} sm={4} className="city-hero" style={{
          backgroundImage: `linear-gradient(135deg, rgba(15, 98, 254, 0.3) 0%, rgba(0, 45, 156, 0.3) 100%), url(${KanoImage})`,
          ...
          <div className="city-hero-content">
            <Breadcrumb>
              ...
              <BreadcrumbItem isCurrentPage>Kano</BreadcrumbItem>
            </Breadcrumb>
          ...
          <Grid className="search-content" fullWidth>
            ...
            <Column lg={12} md={8} sm={4}>
              <div className="listings-results">
                ...
                {loading ? (
                  <Loading description="Loading Kano properties..." />
                ) : (
                  <>
                    <p>{properties.length} properties found in Kano</p>
                    ...
                    <div className="listings-grid">
                      ...
                      {properties.length === 0 && !loading && (
                        <div className="no-results">
                          <p>No properties found in Kano. Try adjusting your search criteria.</p>
                        </div>
                      )}
                    </div>
                  </>
