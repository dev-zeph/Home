...
const Lagos = () => {
  ...
  const lagosAreas = [
    ...
    'Yaba', 'Lagos Island', 'Maryland', 'Gbagada', 'Magodo', 'Ikotun'
  ];
    ...
    <div className="city-page">
      <Grid fullWidth>
        ...
        <Column lg={16} md={8} sm={4} className="city-hero" style={{
          backgroundImage: `linear-gradient(135deg, rgba(15, 98, 254, 0.3) 0%, rgba(0, 45, 156, 0.3) 100%), url(${LagosImage})`,
          ...
          <div className="city-hero-content">
            <Breadcrumb>
              ...
              <BreadcrumbItem isCurrentPage>Lagos</BreadcrumbItem>
            </Breadcrumb>
          ...
          <Grid className="search-content" fullWidth>
            ...
            <Column lg={12} md={8} sm={4}>
              <div className="listings-results">
                ...
                {loading ? (
                  <Loading description="Loading Lagos properties..." />
                ) : (
                  <>
                    <p>{properties.length} properties found in Lagos</p>
                    ...
                    <div className="listings-grid">
                      ...
                      {properties.length === 0 && !loading && (
                        <div className="no-results">
                          <p>No properties found in Lagos. Try adjusting your search criteria.</p>
                        </div>
                      )}
                    </div>
                  </>
